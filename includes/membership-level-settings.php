		...
		<tbody>
			...
			<td>
				<select id="pmpro_bp_restrictions" name="pmpro_bp_restrictions" onchange="pmpro_updateBuddyPressTRs();">
						<option value="0" 
						<?php
						if ( ! $pmpro_bp_restrictions ) {
?>
selected="selected"<?php } ?>><?php _e( 'No', 'pmpro' ); ?></option>
						<option value="1" 
						<?php
						if ( $pmpro_bp_restrictions == 1 ) {
?>
selected="selected"<?php } ?>><?php _e( 'Yes - Lock down all of BuddyPress', 'pmpro' ); ?></option>
						<option value="2" 
						<?php
						if ( $pmpro_bp_restrictions == 2 ) {
?>
selected="selected"<?php } ?>><?php _e( 'Yes - Lock down specific features', 'pmpro' ); ?></option>
				</select><br />
				</td>
			</tr>
			</tbody>
...
>Yes</option>
				...
				<td>
					<select name="pmpro_bp_group_single_viewing" id="pmpro_bp_group_single_viewing">
							<option value= '0' 
							<?php
							if ( $can_view_single_group == 0 ) {
								echo 'selected';}
?>
 >No</option>
							<option value= '1' 
							<?php
							if ( $can_view_single_group == 1 ) {
								echo 'selected';}
?>
>Yes</option>
						</select>
				...
				<td>
					<select name="pmpro_bp_groups_page_viewing" id="pmpro_bp_groups_page_viewing">
							<option value= '0' 
							<?php
							if ( $can_view_groups_page == 0 ) {
								echo 'selected';}
?>
 >No</option>
							<option value= '1' 
							<?php
							if ( $can_view_groups_page == 1 ) {
								echo 'selected';}
?>
>Yes</option>
						</select>
				...
				<td>
					<select name="pmpro_bp_groups_join" id="pmpro_bp_groups_join">
							<option value= '0' 
							<?php
							if ( $can_join_groups == 0 ) {
								echo 'selected';}
?>
 >No</option>
							<option value= '1' 
							<?php
							if ( $can_join_groups == 1 ) {
								echo 'selected';}
?>
>Yes</option>
					</select>
				...
				<td>
					<select name="pmpro_bp_public_messaging" id="pmpro_bp_public_messaging">
							<option value= '0' 
							<?php
							if ( $pmpro_bp_public_messaging == 0 ) {
								echo 'selected';}
?>
 >No</option>
							<option value= '1' 
							<?php
							if ( $pmpro_bp_public_messaging == 1 ) {
								echo 'selected';}
?>
>Yes</option>
					</select>
				...
				<td>
					<select name="pmpro_bp_private_messaging" id="pmpro_bp_private_messaging">
							<option value= '0' 
							<?php
							if ( $pmpro_bp_private_messaging == 0 ) {
								echo 'selected';}
?>
 >No</option>
							<option value= '1' 
							<?php
							if ( $pmpro_bp_private_messaging == 1 ) {
								echo 'selected';}
?>
>Yes</option>
					</select>
				...
				<td>
					<select name="pmpro_bp_send_friend_request" id="pmpro_bp_send_friend_request">
							<option value= '0' 
							<?php
							if ( $pmpro_bp_send_friend_request == 0 ) {
								echo 'selected';}
?>
 >No</option>
							<option value= '1' 
							<?php
							if ( $pmpro_bp_send_friend_request == 1 ) {
								echo 'selected';}
?>
>Yes</option>
					</select>
				...
				<td>
					<select name="pmpro_bp_member_directory" id="pmpro_bp_send_friend_request">
							<option value= '0' 
							<?php
							if ( $pmpro_bp_member_directory == 0 ) {
								echo 'selected';}
?>
 >No</option>
							<option value= '1' 
							<?php
							if ( $pmpro_bp_member_directory == 1 ) {
								echo 'selected';}
?>
>Yes</option>
					</select>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<?php
					if ( count( $group_ids ) > 30 ) {
?>
style="height: 300px; overflow: auto;"<?php } ?>>
						<?php
						...
						if ( bp_has_groups( $groups_args ) ) {
							while ( bp_groups() ) {
								bp_the_group();
								?>
									<div class="clickable"><input type="checkbox" id="pmpro_bp_group_automatic_add_<?php echo $groups_template->group->id; ?>" name="pmpro_bp_group_automatic_add[]" value="<?php echo $groups_template->group->id; ?>" 
																																<?php
																																if ( in_array( $groups_template->group->id, $pmpro_bp_group_automatic_add ) ) {
																							?>
																							checked="checked"<?php } ?>> <?php echo $groups_template->group->name . ' (' . $groups_template->group->status . ')'; ?></div> 
							<?php
							}
						}
						?>
...
style="height: 300px; overflow: auto;"<?php } ?>>
						...
						if ( bp_has_groups( $groups_args ) ) {
							while ( bp_groups() ) {
								bp_the_group();
								?>
									<div class="clickable"><input type="checkbox" id="pmpro_bp_group_can_request_invite_<?php echo $groups_template->group->id; ?>" name="pmpro_bp_group_can_request_invite[]" value="<?php echo $groups_template->group->id; ?>" 
																																	<?php
																																	if ( in_array( $groups_template->group->id, $pmpro_bp_group_can_request_invite ) ) {
																								?>
																								checked="checked"<?php } ?>> <?php echo $groups_template->group->name . ' (' . $groups_template->group->status . ')'; ?></div> 
							<?php
							}
		...
		<tbody>
			...
			<tr>
				...
				<select multiple='yes' name='pmpro_bp_member_types[]'> 
					...
					?>
						<option value= "<?php echo $member_type; ?>" 
													<?php
													if ( is_array( $pmpro_bp_member_types ) && in_array( $member_type, $pmpro_bp_member_types ) ) {
														echo " selected='selected'";}
?>
" ><?php echo $member_type_data->labels['name']; ?></option>
													<?php
					}
					?>
				</select>
